...
from tools.todo_write.types import TodoItem, TodoStatus
from langgraph.graph.state import Command


@tool("TodoWrite", parse_docstring=True, error_on_invalid_docstring=False)
def todo_write_tool(todos: list[TodoItem], tool_call_id: Annotated[str, InjectedToolCallId]):
    ...
    Args:
        todos (list): The updated todo list.

    Returns:
        Command: A command to update state with todos and a tool message.
