...
def ls_tool(
    ...
    Args:
        path (str): The absolute path to list files and directories from. Relative paths are not allowed.
        match (Optional[list[str]]): An optional array of glob patterns to match.
        ignore (Optional[list[str]]): An optional array of glob patterns to ignore.

    Returns:
        str: Formatted result listing directory contents or an error message.
    """
    _path = Path(path)
