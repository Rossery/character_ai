...
def tree_tool(
    ...
    Args:
        path (Optional[str]): Directory path to display. Defaults to current working directory if not specified.
        max_depth (Optional[int]): Maximum depth to traverse (≤ 3). Defaults to 3.

    Returns:
        str: A tree-structured view of the directory.
    """
    # Set search path
